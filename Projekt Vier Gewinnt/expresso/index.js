...
const rows = 6
const cols = 7
var express = require('./expresso/node_modules/express')
var app = express()
...
console.log("Go to http://localhost:3000/connect4.html")



// in Projekt node index.js
// => Express started on port 3000
// http://localhost:3000/connect4.html => Spiel laden